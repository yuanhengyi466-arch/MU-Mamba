...
The repository intentionally excludes raw datasets, trained checkpoints, pretrained weights, non-release research branches, and experiment outputs.
...
- Put datasets under `data/`; this folder is ignored by Git.
- Put checkpoints and predictions under `outputs/`; this folder is ignored by Git.
- Do not commit pretrained weights or trained checkpoints. Use GitHub Releases, Hugging Face, or Zenodo for large artifacts.
